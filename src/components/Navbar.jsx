  ...
  return (
    <>
      <div className={colorChange ? "Navbar" : "Navbar-scroll"}>
        <p className="nav-name">M.Belahouane</p>
        <Squash
          toggled={isOpen}
          toggle={() => setIsOpen(!isOpen)}
          hideOutline={true}
          onToggle={() => setToggleMenu(!toggleMenu)}
          duration={0.5}
        />
        <div className="links">
          ...
          <a
            href="#about"
            className={isSelected("about") + " " + "navbar-link"}
          >
            About
          </a>
          <a
      ...
      {toggleMenu && (
        <div className="small-nav">
          <div className="small-nav-links">
            <a onClick={onLinkClick} href="#main">
              Home
            </a>
            <a onClick={onLinkClick} href="#about">
              About
            </a>
            <a onClick={onLinkClick} href="#projects">
              Projects
            </a>
